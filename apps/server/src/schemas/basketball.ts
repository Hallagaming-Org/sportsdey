		...
		home: z
			.object({
				...
				points: z
					.number()
					.nullable()
					.openapi({ description: "Home team points" }),
				imageUrl: z
					.string()
					.url()
					.nullable()
		...
		away: z
			.object({
				...
				points: z
					.number()
					.nullable()
					.openapi({ description: "Away team points" }),
				imageUrl: z
					.string()
					.url()
					.nullable()
...
export const PlayerStatisticsSchema = z
	.object({
		...
		field_goals_att: z
			.number()
			.openapi({ description: "Field goals attempted" }),
		field_goals_pct: z
			.number()
			.openapi({ description: "Field goals percentage" }),
		three_points_made: z.number().openapi({ description: "Three points made" }),
		three_points_att: z
			.number()
			.openapi({ description: "Three points attempted" }),
		three_points_pct: z
			.number()
			.openapi({ description: "Three points percentage" }),
		free_throws_made: z.number().openapi({ description: "Free throws made" }),
		free_throws_att: z
			.number()
			.openapi({ description: "Free throws attempted" }),
		free_throws_pct: z
			.number()
			.openapi({ description: "Free throws percentage" }),
		rebounds: z.number().openapi({ description: "Rebounds" }),
		offensive_rebounds: z
			.number()
			.openapi({ description: "Offensive rebounds" }),
		defensive_rebounds: z
			.number()
			.openapi({ description: "Defensive rebounds" }),
...
export const PlayerSchema = z
	.object({
		...
		statistics: PlayerStatisticsSchema.openapi({
...
export const TeamSchema = z
	.object({
		...
		starters: z
			.array(PlayerSchema)
			.optional()
			.openapi({ description: "Starters" }),
		bench: z
			.array(PlayerSchema)
			.optional()
			.openapi({ description: "Bench players" }),
		score: z
			.object({
				quarter1: z
					.number()
					.optional()
					.openapi({ description: "Quarter 1 score" }),
				quarter2: z
					.number()
					.optional()
					.openapi({ description: "Quarter 2 score" }),
				quarter3: z
					.number()
					.optional()
					.openapi({ description: "Quarter 3 score" }),
				quarter4: z
					.number()
					.optional()
					.openapi({ description: "Quarter 4 score" }),
				over_time: z
					.number()
					.optional()
					.openapi({ description: "Overtime score" }),
		...
		tournament: z
			.object({
				...
				imageUrl: z
					...
					.nullable()
					.optional()
					.openapi({ description: "Tournament image" }),
			})
...
export const GameTeamStatsSchema = z
	.object({
...
export const BasketballTournamentScheduleSchema = z
	.object({
		games: z.array(ScheduledGameSchema).openapi({ description: "Games" }),
