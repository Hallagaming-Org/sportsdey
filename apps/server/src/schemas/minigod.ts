...
export const MinigodLauncherResponseSchema = z
	.object({
...
export const LagosRushBalanceRequestSchema = z
	.object({
...
export const LagosRushBalanceResponseSchema = z
	.object({
		success: z.literal(true).openapi({ description: "Success status" }),
		data: z
			.object({
	...
	.object({
		...
		data: z
			.object({
				oldBalance: z
					.number()
					.openapi({ description: "Previous balance in kobo" }),
...
export const LagosRushCreditRequestSchema = z
	.object({
...
export const LagosRushCreditResponseSchema = z
	.object({
		success: z.literal(true).openapi({ description: "Success status" }),
		data: z
			.object({
...
export const LagosRushRefundRequestSchema = z
	.object({
		playerId: z.string().openapi({ description: "Player ID" }),
		amount: z.number().openapi({ description: "Amount in kobo" }),
		currency: z.string().openapi({ description: "Currency code" }),
...
export const LagosRushRefundResponseSchema = z
	.object({
		success: z.literal(true).openapi({ description: "Success status" }),
		data: z
			.object({
...
export const MinigodErrorSchema = z
	.object({
