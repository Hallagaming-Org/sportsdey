...
export const UserNotificationListResponseSchema = z.object({
	...
	data: z.object({
		notifications: z.array(UserNotificationResponseSchema).openapi({ description: "Notifications" }),
		total: z.number().openapi({ description: "Total number of notifications" }),
...
export const UserNotificationSingleResponseSchema = z.object({
	success: z.literal(true).openapi({ description: "Success status" }),
	data: UserNotificationResponseSchema.openapi({ description: "Notification" }),
