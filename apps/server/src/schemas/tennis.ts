...
export const TennisCompetitorSchema = z.object({
	...
	qualifier: z.enum(["home", "away"]).openapi({ description: "Home or away" }),
...
export const TennisSetScoreSchema = z.object({
	...
	tiebreak_score: z.number().optional().openapi({ description: "Tiebreak score" }),
...
export const TennisMatchSchema = z.object({
	...
	home: z.object({
		...
		set_scores: z.array(TennisSetScoreSchema).openapi({ description: "Set scores" }),
	}).openapi("TennisHome"),
	away: z.object({
...
export const TennisCompetitionGroupSchema = z.object({
	competition: z.object({
		...
		type: z.string().optional().openapi({ description: "Competition type" }),
		gender: z.string().optional().openapi({ description: "Competition gender" }),
...
export const TennisScheduleData = z.object({
	...
	competitions: z.array(TennisCompetitionGroupSchema).openapi({ description: "Competitions" }),
