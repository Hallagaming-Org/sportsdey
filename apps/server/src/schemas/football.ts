...
export const TransformedMatchInfoSchema = z
	.object({
		competition: z
			.object({
				...
				imageUrl: z
					...
					.nullable()
					.optional()
					.openapi({ description: "Competition image" }),
				country: z
					.object({
						...
						flag: z
							...
							.nullable()
							.optional()
							.openapi({ description: "Country flag" }),
					})
					.optional()
			...
			.object({
				home: z
					.object({
						...
						shortName: z
							.string()
							.openapi({ description: "Home team short name" }),
						...
						imageUrl: z
							...
							.nullable()
							.optional()
							.openapi({ description: "Home team image" }),
					})
				...
				away: z
					.object({
						...
						shortName: z
							.string()
							.openapi({ description: "Away team short name" }),
						...
						imageUrl: z
							...
							.nullable()
							.optional()
							.openapi({ description: "Away team image" }),
					})
			...
			.array(
				z.object({
					...
					imageUrl: z
						...
						.nullable()
						.optional()
						.openapi({ description: "Team image" }),
			...
			.array(
				z.object({
					...
					imageUrl: z
						...
						.nullable()
						.optional()
						.openapi({ description: "Player image" }),
					team: z
						.object({
							id: z.string().openapi({ description: "Team ID" }),
							name: z.string().openapi({ description: "Team name" }),
							abbreviation: z
								.string()
								.openapi({ description: "Team abbreviation" }),
							imageUrl: z
								.string()
								.url()
								.nullable()
		...
		homeH2H: z
			.array(
				z.object({
					...
					result: z
						.enum(["W", "D", "L"])
						.openapi({ description: "Match result" }),
...
export const TransformedResponseSchema = z
	.object({
		competitions: z
			.array(
				z
							...
							.array(
								z
									.object({
											...
											.object({
												home: z
													.object({
														id: z
															.string()
															.openapi({ description: "Home team ID" }),
														name: z
															.string()
															.openapi({ description: "Home team name" }),
														score: z
															.number()
															.openapi({ description: "Home score" }),
														imageUrl: z
															.string()
															.url()
															.nullable()
												...
												away: z
													.object({
														id: z
															.string()
															.openapi({ description: "Away team ID" }),
														name: z
															.string()
															.openapi({ description: "Away team name" }),
														score: z
															.number()
															.openapi({ description: "Away score" }),
														imageUrl: z
															.string()
															.url()
															.nullable()
										...
										match_status: z
											.string()
											.openapi({ description: "Match status" }),
										clock: z
											.number()
											.optional()
											.openapi({ description: "Match clock" }),
									})
...
const TeamStatsSchema = z
	.object({
		ballPossession: z
			.number()
			.openapi({ example: 65, description: "Ball possession %" }),
		shotsOnTarget: z
			.number()
			.openapi({ example: 3, description: "Shots on target" }),
		shotsOffTarget: z
			.number()
			.openapi({ example: 12, description: "Shots off target" }),
		...
		yellowCards: z
			.number()
			.openapi({ example: 3, description: "Yellow cards" }),
		secondYellowCards: z
			.number()
			.openapi({ example: 0, description: "Second yellow cards" }),
...
export const MatchStatsSchema = z
	.object({
		home: z
			.object({
				statistics: TeamStatsSchema.openapi({
					description: "Home team statistics",
				}),
				name: z.string().openapi({
					example: "Melbourne City",
		...
		away: z
			.object({
				...
				name: z
					.string()
					.openapi({ example: "Brisbane Roar", description: "Away team name" }),
		...
		date: z
			.string()
			.openapi({ example: "06/01/2026 08:00:00", description: "Match date" }),
		id: z.number().openapi({ example: 1985541, description: "Match ID" }),
	})
	.openapi("MatchStats");

export const FullStandingsSchema = z
	.object({
		tournament: z
			.object({
		...
		standings: z
			.array(
				z.object({
					name: z
						.string()
						.openapi({ example: "Arsenal", description: "Team name" }),
					...
					statistics: z
						.object({
							...
							GD: z
								.number()
								.openapi({ example: 26, description: "Goal difference" }),
