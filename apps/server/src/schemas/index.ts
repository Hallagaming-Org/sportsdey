...
export const ErrorDetailSchema = z.object({
	field: z.string().openapi({ description: "Field name that failed validation" }),
...
export const ErrorResponseSchema = z.object({
	...
	details: z.array(ErrorDetailSchema).nullable().openapi({ description: "Validation error details" }),
...
export const VideoResponseSchema = z.object({
	nextPageToken: z.string().optional().openapi({ description: "Next page token" }),
	prevPageToken: z.string().optional().openapi({ description: "Previous page token" }),
