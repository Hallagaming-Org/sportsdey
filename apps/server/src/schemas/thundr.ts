...
export const ThundrPlayRequestSchema = z
	.object({
		gameId: ThundrGameIdSchema.openapi({
			param: { name: "gameId", in: "path" },
		}),
	})
	.openapi("ThundrPlayRequest");

export const ThundrPlayResponseSchema = z
	.object({
...
export const ThundrErrorSchema = z
	.object({
...
export const ThundrSessionRequestSchema = z
	.object({
		sessionToken: z.string().openapi({ param: { name: "sessionToken" } }),
	})
	.openapi("ThundrSessionRequest");

export const ThundrSessionResponseSchema = z
	.object({
...
export const ThundrSessionErrorResponseSchema = z
	.object({
		errors: z
			.array(
				z.object({
					code: z
						...
						.openapi({ description: "Error code" }),
					isClientSafe: z
						.literal(true)
						.openapi({ description: "Is client safe" }),
				}),
			)
...
export const ThundrInsufficientBalanceErrorSchema = z
	.object({
		errors: z
			.array(
				z.object({
...
export const ThundrTransactionErrorResponseSchema = z
	.object({
		errors: z
			.array(ThundrTransactionErrorSchema)
			.openapi({ description: "Errors" }),
	})
	.openapi("ThundrTransactionErrorResponse");

const ThundrTransactionBaseSchema = z
	.object({
		type: z
			.enum(["BET", "WIN", "LOSE", "DRAW", "ROLLBACK"])
...
export const ThundrBetTransactionSchema = z
	.object({
		...
		serviceFee: z
			.number()
			.optional()
			.openapi({ description: "Service fee in kobo" }),
	})
	.openapi("ThundrBetTransaction");

export const ThundrWinTransactionSchema = z
	.object({
...
export const ThundrLoseTransactionSchema = z
	.object({
...
export const ThundrDrawTransactionSchema = z
	.object({
...
export const ThundrRollbackTransactionSchema = z
	.object({
		...
		originalTransactionId: z
			.string()
			.openapi({ description: "Original transaction ID" }),
	})
	.openapi("ThundrRollbackTransaction");

export const ThundrTransactionRequestSchema = z
...
export const ThundrTransactionResponseSchema = z
	.object({
		transactionId: z.string().openapi({ description: "Transaction ID" }),
		userId: z.string().openapi({ description: "User ID" }),
		currency: z.string().openapi({ description: "Currency" }),
...
export const ThundrBalanceRequestSchema = z
	.object({
		userId: z.string().openapi({ param: { name: "userId", in: "path" } }),
	})
	.openapi("ThundrBalanceRequest");

export const ThundrBalanceQuerySchema = z
	.object({
		sessionId: z.string().openapi({ description: "Session ID" }),
		currency: z.string().openapi({ description: "Currency" }),
...
export const ThundrBalanceResponseSchema = z
	.object({
