        ...
        <div className="mt-6 text-center">
          ...
          <div className="flex items-center justify-center gap-5">
            <button
              ...
              className="flex h-11 w-11 items-center justify-center rounded-full bg-[#1877F2] transition-transform hover:scale-105"
            >
            ...
            <button
              ...
              className="flex h-11 w-11 items-center justify-center rounded-full bg-white shadow-[0_2px_8px_rgba(0,0,0,0.08)] border border-gray-100 transition-transform hover:scale-105"
            >
