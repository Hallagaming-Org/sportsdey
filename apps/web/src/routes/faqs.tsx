...
function FAQs() {
	...
	return (
		<div className="flex min-h-screen flex-col items-center bg-[#000606] px-4 py-12 text-white">
			<div className="flex w-full max-w-3xl flex-col items-center">
				<h1 className="mb-3 text-center font-bold text-3xl sm:text-4xl">
					Frequently Asked Questions
				</h1>
				<p className="mb-8 text-center text-[#A0A0A0] text-sm sm:text-base">
					...
					{filteredFaqs.map((faq, index) => {
						...
						return (
							<Accordion.Item
								...
								value={value}
								className={cn(
									"cursor-pointer rounded-lg border px-5 py-2 transition-colors",
									isActive
							...
							>
								<Accordion.Header className="flex">
									<Accordion.Trigger className="group flex flex-1 items-center justify-between py-4 text-left outline-none">
										<span
											className={cn(
												"pr-4 font-medium text-sm sm:text-base",
