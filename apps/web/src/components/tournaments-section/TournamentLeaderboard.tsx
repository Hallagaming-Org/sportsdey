					...
					<tbody>
						{isLoading ? (
							<tr>
								<td
									colSpan={5}
									className="px-3 py-8 text-center text-[#8C8F8F] sm:px-5"
								>
									Loading leaderboard...
								</td>
							</tr>
							...
							<tr>
								<td
									...
									className="px-3 py-8 text-center text-[#8C8F8F] sm:px-5"
								>
									No leaderboard yet for this tournament.
								</td>
							</tr>
						) : (
							entries.map((entry) => (
								...
								>
									...
									<td className="px-3 py-3 sm:px-5">
										<div className="flex min-w-0 items-center gap-3">
											<span
												className={cn(
													"inline-flex size-8 shrink-0 items-center justify-center rounded-full border border-white/20 font-bold text-[11px]",
