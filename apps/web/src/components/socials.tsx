...
const Socials = () => {
	...
	return (
		<div className="my-4 hidden w-full px-8 md:px-0 lg:flex lg:justify-center">
			<div className={`mt-4 flex w-full h-[104px] py-4  max-w-[90%] items-center overflow-hidden rounded-full  h-[46px] border border-[#F2EEFB]/10 ${currentTheme === "dark" ? "bg-[#04100B]" : "bg-white"}`}>
				<tv-ticker-tape
